        ...
        <div class="form-grid">
            ...
            >
                ...
                >
                    ...
                    <option
                        value="essencial"
                        @selected(old('classificacao') === 'essencial')
                    >
                        Essencial
                    </option>
                    ...
                    <option
                        value="nao_essencial"
                        @selected(old('classificacao') === 'nao_essencial')
                    >
                        Não essencial
                    </option>
                </select>
                ...
                <span class="form-hint">
                    Usado apenas nas categorias de despesa.
                </span>
